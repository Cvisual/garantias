...
?>
              ...
              <div class="col-md-12 col-lg-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Servicio Tecnico &nbsp; &nbsp;<button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                      <form name="formulario" id="formulario" method="POST">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                         
                          <h1 style="text-align: center;"><strong>FORMATO ÚNICO DE GARANTIA SERVICIO TECNICO</strong></h1>
                        </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          <label>Cliente:</label>
                          <input type="hidden" name="idserviciotecnico" id="idserviciotecnico">
                      ...
                      <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          &nbsp;
                          <button class="btn btn-success" onclick="javascript:imprimir()" type="button" id="imprimir"><i class="fa fa-print"></i> Imprimir</button>
                        </div>
                    </div>
  ...
  <script type="text/javascript" src="scripts/mayorista.js"></script>
  <?php
  }
  ob_end_flush();
  ?>
