                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                          <div class="small-box bg-green">
                              <div class="inner text-center">
                                ...
                                <a class="link" href="serviciotecnico.php">
                              ...
                              <a href="serviciotecnico.php" class="small-box-footer">Servicio Tecnico  <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                          <div class="small-box bg-red">
                              <div class="inner text-center">
                                ...
                                <a class="link" href="clientefinal.php">
                              ...
                              <a href="clientefinal.php" class="small-box-footer">Cliente Final  <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
